...
public struct ModelCatalog: Codable, Sendable {
    ...
    public static func load(from url: URL) throws -> ModelCatalog {
        ...
        guard catalog.schemaVersion == 1 else {
            throw PrivateDocSearchError.processFailed("Nicht unterstützte Modellkatalog-Version.")
        }
    ...
    public static func bundled() throws -> ModelCatalog {
        guard let url = Bundle.module.url(
            ...
            throw PrivateDocSearchError.processFailed("Der lokale Modellkatalog fehlt.")
        }
